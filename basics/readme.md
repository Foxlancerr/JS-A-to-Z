...
- We check the length of arr in the i for loop and the <code>arr[i]</code> length in the j for loop.
...
- If radix is 8: The string is interpreted as an octal (base 8) number.
